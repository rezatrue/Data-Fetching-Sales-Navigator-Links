...
public class ChromeOperator {
	...
	//
	// return "";
	// //driver.findElement(By.cssSelector("a.org-about-us-company-module__website.mb3.link-without-visited-state.ember-view")).getAttribute("href").toString();
	// }

	public String companyEmplyeListPage() {
		driver.findElement(By.cssSelector(
				"a.org-company-employees-snackbar__details-highlight.snackbar-description-see-all-link.link-without-visited-state.ember-view"))
				.click();
		return "";
	}
